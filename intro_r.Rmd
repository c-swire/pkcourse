...
This page walks you through an introduction to RStudio. 
...
Let's get some PK data in to work with. I have put the data set on Github which you can call using the following command:
...
Piping is a tool that allows us to undertake multiple logical steps to achieve a desired output in our text. 
