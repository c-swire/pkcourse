...
As you can see here, $T_{max}$ after an IV bolus is at t=0. As a result, this is not a parameter that is reported for IV bolus data. 
...
summary(results1) #summarise the results
```
```{r, echo=FALSE}
...
knitr::kable(summary(results1), booktabs = TRUE, caption='PKNCA output') %>%
